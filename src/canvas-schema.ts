...
export const canvasNodeSchema: CanvasNodeSchema[] = [
  ...
  { type: 'reference-image', category: 'Input', label: 'Asset Upload', description: 'Add an image or 3D model input', presentation: { kind: 'INPUT', detail: 'Reference asset', tone: 'cyan' }, inputs: {}, outputs: { image: { type: 'any', label: 'Asset' } }, defaults: { reference: '', assetType: 'image' }, parameters: [] },
