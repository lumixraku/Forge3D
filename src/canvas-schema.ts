...
export const canvasNodeSchema: CanvasNodeSchema[] = [
  ...
  { type: 'reference-image', category: 'Input', label: 'Image Upload', description: 'Add an image or asset input', presentation: { kind: 'INPUT', detail: 'Reference source', tone: 'cyan' }, inputs: {}, outputs: { image: { type: 'image' } }, defaults: { reference: '' }, parameters: [] },
