...
export const canvasNodeSchema: CanvasNodeSchema[] = [
  ...
  { type: 'reference-image', category: 'Input', label: 'Image Upload', description: 'Add an image or asset input', presentation: { kind: 'INPUT', detail: 'Reference source', tone: 'cyan' }, inputs: {}, outputs: { image: { type: 'image' } }, defaults: { reference: '', preview: '/shark-reference.png' }, parameters: [] },
  { type: 'generated-image', category: 'Output', label: 'Image', description: 'An image created by a canvas step', presentation: { kind: 'OUTPUT', detail: 'Generated view', tone: 'amber' }, inputs: { image: { type: 'image' } }, outputs: { image: { type: 'image' } }, hidden: true, defaults: { preview: '/shark-concept-front.png' }, parameters: [] },
