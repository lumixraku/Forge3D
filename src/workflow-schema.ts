...
export const workflowNodeSchema: WorkflowNodeSchema[] = [
  ...
  { type: 'reference-image', category: 'Input', label: 'Image Upload', description: 'Add an image or asset input', presentation: { kind: 'INPUT', detail: 'Reference source', tone: 'cyan' }, inputTypes: [], outputType: 'image', defaults: { reference: '', preview: '/shark-reference.png' }, parameters: [{ key: 'reference', label: 'Image', control: 'text', placeholder: 'JPG, PNG or WEBP · max 20 MB' }] },
  ...
  { type: 'split', category: '3D', label: 'Split', description: 'Split a model into parts', presentation: { kind: 'SPLIT', detail: 'Part segmentation', tone: 'cyan' }, inputTypes: ['model'], outputType: 'model', executable: true, modelEditor: true, defaults: { detailLevel: 'low', preview: '/shark-model.png' }, parameters: [{ key: 'detailLevel', label: 'Detail Level', control: 'segmented', options: detailLevels }] },
