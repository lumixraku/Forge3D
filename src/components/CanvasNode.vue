...
:deep(.vue-flow__handle.canvas-handle::after) { position: absolute; top: 50%; width: 20px; height: 20px; border: 3px solid #111313; border-radius: 50%; background: var(--node-accent); box-shadow: 0 0 0 3px color-mix(in srgb, var(--node-accent) 22%, transparent); content: ''; transition: box-shadow .12s ease; }
...
:global(:root[data-theme='light']) :deep(.vue-flow__handle.canvas-handle::after), :global(:root[data-theme='light']) .node-next-button { border-color: #fff; }
